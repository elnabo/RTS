...
class Configs
{
	...
	// TownCenter info.
	public static var townCenterWidth:Array<Int> = [122,128];
	public static var townCenterHeight:Array<Int> = [118,128];
	// townCenterImageStartPos[version] = [ x, y ]
	public static var townCenterImageStartPos:Array<Array<Int>> = [[5,5],[0,0],[0,0]];
